...
import 'package:movie_app/core/serverses/services.locator.dart';
import 'package:movie_app/core/util/app_constance.dart';
import 'package:movie_app/core/util/app_string.dart';
import 'package:movie_app/core/util/enum.dart';
import 'package:movie_app/movies_module/domain/entities/genres.dart';
import 'package:movie_app/movies_module/presentation/controller/bloc/movie_details_bloc.dart';
import 'package:movie_app/movies_module/presentation/screens/dummy.dart';
...
class MovieDetailContent extends StatelessWidget {
  ...
  String _showGenres(List<Genres> generes) {
    String result = '';
    for (var genere in generes) {
      result += '${genere.name}, ';
    }
          ...
          (context, index) {
            ...
            return FadeInUp(
              ...
              child: ClipRRect(
                ...
                child: CachedNetworkImage(
                  imageUrl: AppConstace.imageUrl(recommendation.backdropPath!),
